...
def get_object_properties(args):
   ...
   print('- (pmra, pmdec) = (%g, %g) mas/yr'%(args.pmra, args.pmdec))
   print('- pmra max min = [%s, %s] m.a.s./yr.'%(round(args.min_pmra, 5), round(args.max_pmra, 5)))
   print('- pmdec max min = [%s, %s] m.a.s./yr.'%(round(args.min_pmdec, 5), round(args.max_pmdec, 5)))
